...
| 6주차 |  [![6주차 내용](https://img.shields.io/badge/6주차_내용-60a5fa)](https://github.com/hyemi0622/KNU_SW_python_project_team_8/tree/main/Week/6th_Week)   | 플로우차트 짜기 , 발표 대본 작성, 코드 수정 | 발표 대본 , 정확률 계산, 워드클라우드 개발  | 깃허브 수정, 발표 ppt , 가령언니가 추가 개발한 거 UI 개선 |![status](https://img.shields.io/badge/Not%20started-112051) |
