...
| 4주차 | [![4주차 내용](https://img.shields.io/badge/4주차_내용-60a5fa)](https://github.com/hyemi0622/KNU_SW_python_project_team_8/tree/main/Week/4th_Week)  | Word Game + Memory Game 개발 | chat 기능 개발 | 웹사이트 home, chat화면, What is? 파트 개발 |![status](https://img.shields.io/ba정 | 발표 대본 , 정확률, 워드클라우드 계산 개발  | 깃허브 수정, 발표 ppt , 가령언니가 추가 개발한 거 UI 개선 |![status](https://img.shields.io/badge/Not%20started-112051) |
