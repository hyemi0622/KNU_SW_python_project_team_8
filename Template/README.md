...
Q
Q 그 단어는 명사, 동사, 형용사 중 어떤 품사였나요?  
Q 어떤 감정과 연결된 단어였나요? (예: 분노, 기쁨, 아련함 등)
Q 누군가가 자주 썼던 말인가요? 그렇다면 누구인가요?
Q 뉴스, 책, 영화 중 어디서 접했던 단어였나요?
Q 그 단어를 어디에 적어두었거나, 봤던 기록이 있나요?
Q 그 단어의 첫 글자나 음절이 기억나나요?
Q 어떤 소리나 음악, 리듬과 연결된 느낌이 있나요?
Q 단어를 들었을 때 머릿속에 어떤 이미지가 떠오르나요?
Q 해당 단어는 일상적인가요, 아니면 특정 분야(예: 법, IT, 의학 등)의 전문용어인가요?
Q 그 단어를 누군가에게 설명하려 했던 적이 있었나요?
Q 그 단어를 써야 하는데 비슷한 다른 단어로 대체했던 적 있나요?
Q 그 단어와 반대되는 뜻을 가진 단어를 아시나요?
Q 사전에서 찾아봤던 기억이 있나요? 어떤 앱이나 도구를 썼나요?
